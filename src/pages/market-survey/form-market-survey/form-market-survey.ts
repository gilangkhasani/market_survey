...
import { CrudApiProvider, ToastProvider, LoadingProvider } from '../../../providers/providers';
...
@IonicPage()
@Component({
  selector: 'page-form-market-survey',
  templateUrl: 'form-market-survey.html',
})
export class FormMarketSurveyPage {
  ...
  constructor(private view: ViewController, private toast: ToastProvider, private loading: LoadingProvider,  private crud: CrudApiProvider, public params: NavParams, public http : Http, public toastCtrl:ToastController, private alertCtrl: AlertController, public navCtrl: NavController, private global : AppState, private geolocation: Geolocation, private datepipe: DatePipe) {
  ...
  submit(){
    this.loading.present();
    this.crud.save(this.formData, this.token).then(data => {
      console.log(data);
